...
boot_alloc(uint32_t n)
{
	...
	if (n > 0){
		...
		newfree = ROUNDUP(n+nextfree, PGSIZE);
...
// boot_alloc alokuje pamat pre vsetky npages velkosti struct PageInfo
...
// treba ju vsak z nezmyselnych dovodov premenit na virtualnu adresu
